...
var numer = document.querySelector('.part-of-honor .honor-box').getBoundingClientRect();

var getw = Math.floor(numer.width * 0.9);
var getH = Math.floor(numer.height * 0.9);
...
$(function () {
  ...
  function letvIfraem(ul) {
    ...
    letv3D.innerHTML =
      '<span class="letvclose cursor poA">退出</span><iframe src="' +
      ul +
